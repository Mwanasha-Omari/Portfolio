...
function NavLink({ href, children, onClick }: NavLinkProps) {
  return (
    <a 
      href={href} 
      className="ml-4 text-primary-amber hover:text-light-blue font-bold text-lg transition-colors duration-300"  
      onClick={onClick}>
      {children}
    </a>
  );
...
function MobileNavLink({ href, children, onClick }: MobileNavLinkProps) {
  return (
    <a 
      href={href} 
      onClick={onClick} 
      className="block px-3 py-4 text-lg font-bold text-primary-amber hover:text-light-blue transition-colors duration-300"> 
      {children}
    </a>
  );
}
